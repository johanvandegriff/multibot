...
var (
	//only the main container needs these
	...
	//both containers need these
	STATE_DB_URL                = os.Getenv("STATE_DB_URL")                //common
	STATE_DB_PASSWORD           = os.Getenv("STATE_DB_PASSWORD")           //common
	TWITCH_SUPER_ADMIN_USERNAME = os.Getenv("TWITCH_SUPER_ADMIN_USERNAME") //common, tenant
	...
	//only the tenant container needs these
